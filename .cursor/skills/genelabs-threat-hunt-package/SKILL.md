...
| Blank "Execution Log" and "Outcome & Classification" sections | Ruled lines for someone to write on. The hunt is executed by the Falcon Hunt task or by an analyst working in Falcon and Splunk, and the result is written into a report, not back into the package. |
...
Either the scheduled Falcon Hunt task (weekdays 16:03), or April interactively in
