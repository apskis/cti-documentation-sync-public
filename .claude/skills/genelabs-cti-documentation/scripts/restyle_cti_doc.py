...
def main():
    ...
    ap.add_argument("--tlp", default="none",
                    help="Footer TLP level. Default 'none': internal program "
                         "documentation carries no TLP marking. Use AMBER or "
                         "AMBER+STRICT only on documents that leave GeneLabs.")
